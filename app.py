...
st.set_page_config(page_title="ChatAssist | Conversational AI Analytics", layout="wide", page_icon="\U0001f4ac")
with st.sidebar:
    st.header("\u2699 Config"); n=st.slider("Samples",2000,20000,10000,1000); tau=st.slider("Threshold",0.05,0.95,0.50,0.05)
    st.caption("Conversational AI | Intent Classification")
